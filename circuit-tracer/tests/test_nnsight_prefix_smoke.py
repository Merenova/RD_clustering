"""E2E smoke: public attribute_prefix_to_continuations dispatches to nnsight
when given an NNSightReplacementModel, and returns a usable PrefixContinuationResult.
"""
import sys
...
# IMPORTANT: import from the public package, not from attribute_nnsight_prefix
...
@pytest.mark.slow
def test_e2e_public_dispatch_gemma3():
    ...
    assert getattr(model, "backend", None) == "nnsight"
