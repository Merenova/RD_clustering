...
def compute_continuation_log_prob_batched(
    ...
    Args:
        ...
        first_token_only: If True, only compute log prob of first continuation token
    ...
    for batch_idx, (cont_ids, cont_start) in enumerate(batch_cont_info):
        ...
        num_tokens = 1 if first_token_only else len(cont_ids)
        valid_len = min(num_tokens, seq_len - cont_start)
